            ...
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="pemilik" value="{{ old('name') }}"
                            ...
                            <div class="w-100">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="no_uji" 
                                        id="basic-icon-default-company" placeholder="JKT21331" class="form-control" />
                                </div>
                            </div>
                            <div class="w-100">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="text" name="no_kendaraan"
                                        id="basic-icon-default-company" placeholder="B 2332 AB" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="d-flex gap-3 mb-3 w-100">
                        ...
                        <div class="d-flex gap-3 mb-3 w-100">
                            <div class="w-100">
                                ...
                                <select class="form-select" name="jenis_kendaraan" id="exampleFormControlSelect1"
                                    ...
                                    <option value="BUMN">Pickup</option>
                                    <option value="CPNS">Truk</option>
                                </select>
                            </div>
                            <div class="col-xxl-4">
                                <div class="mb-3">
                                    ...
                                    <div class="col-md-10">
                                      <input class="form-control" name="masa_berlaku" type="date" value="2021-06-18" id="html5-date-input" />
                                    </div>
                                  </div>
                            </div>
                            {{-- <div class="w-100">
                            ...
                            <div class="w-100">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="no_buku" 
                                        id="basic-icon-default-company" placeholder="123312" class="form-control" />
                                </div>
                            </div>
                            <div class="w-100">
                                <label class="form-label" for="basic-icon-default-company">Jbb</label>
                                <div class="input-group input-group-merge">
                                    <input type="text" name="jbb"
